...
init();
// could move init into game class as static method Game.init(); will start and set a new game
// 
function init() {
  WordAPI.getWords();
  //let game = new Game(give new id and set score as zero)
  // in eventlistenter checkMatch changes to game.checkMatch()
  wordInput.addEventListener('input', checkMatch)
}
// could move run into game class Instance method let game = Game.new; game.run()
function run() {
  if(isPlaying) {
    return;
  }
